...
from fuxictr.fxTensorflow.tf_utils import get_optimizer, get_loss
...
class BaseModel(Model):
    ...
    # TODO 多任务的时候需要重写函数
    def get_multiple_label(self, inputs):
    ...
    def checkpoint_and_earlystop(self, logs, min_delta=1e-6):
        """
        早停函数，如果当前指标大于_best_metric - min_delta 或者小于 _best_metric + min_delta，则 _stopping_steps 加 1，如果
        _stopping_steps 超过 _early_stop_patience，则模型停止训练
        :param logs:
        :param min_delta:
        """
